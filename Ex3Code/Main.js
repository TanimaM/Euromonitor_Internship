        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, addBooks()];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 12];
                case 2:
                    if (!(option === 2)) return [3 /*break*/, 3];
                    library.listAvailableBooks();
                    return [3 /*break*/, 12];
                case 3:
                    if (!(option === 3)) return [3 /*break*/, 5];
                    return [4 /*yield*/, searchBooks()];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 12];
                case 5:
                    if (!(option === 4)) return [3 /*break*/, 7];
                    return [4 /*yield*/, issueBook()];
                case 6:
                    _a.sent();
                    return [3 /*break*/, 12];
                case 7:
                    if (!(option === 5)) return [3 /*break*/, 9];
                    return [4 /*yield*/, returnBook()];
                case 8:
                    _a.sent();
                    return [3 /*break*/, 12];
                case 9:
                    if (!(option === 6)) return [3 /*break*/, 11];
                    return [4 /*yield*/, removeBook()];
                case 10:
                    _a.sent();
                    return [3 /*break*/, 12];
                case 11:
...
function searchBooks() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prompt("Enter the title or author to search: ")];
                case 1:
                    query = _a.sent();
