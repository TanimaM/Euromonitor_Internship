...
var UserApp = /** @class */ (function () {
    ...
    UserApp.prototype.fetchData = function (url) {
    ...
    UserApp.prototype.displayUsers = function (users) {
        var _this = this;
        users.forEach(function (user) {
            ...
            userElement.addEventListener('click', function () {
                _this.navigateToUserDetails(user);
            });
            if (_this.userListElement) {
                _this.userListElement.appendChild(userElement);
            }
        });
    };
    UserApp.prototype.navigateToUserDetails = function (user) {
    ...
    UserApp.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var users, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.fetchData('https://reqres.in/api/users')];
                    case 1:
                        users = _a.sent();
