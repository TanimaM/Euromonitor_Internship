...
var BankApplication = /** @class */ (function () {
    ...
    BankApplication.prototype.promptAge = function (customerName, ageTries, accountType) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ageInput = this.prompt('Age: ');
                        age = parseInt(ageInput);
                        if (!isNaN(age)) return [3 /*break*/, 2];
                        this.displayInvalidAgeMessage();
                        return [4 /*yield*/, this.promptAge(customerName, ageTries, accountType)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        if (age > 68) {
                            return [2 /*return*/, this.handleAgeGreaterThan68(customerName, ageTries, accountType)];
                        }
                        else {
    ...
    BankApplication.prototype.displayInvalidAgeMessage = function () {
        console.log('Please enter a valid number less than 68 for age.');
    };
    BankApplication.prototype.handleAgeGreaterThan68 = function (customerName, ageTries, accountType) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
